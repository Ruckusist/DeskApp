...
from deskapp.deskchat.server import get_status as server_status, start as server_start
from deskapp.deskchat.client.manager import init_app as client_init, login as client_login
...
class Login(Module):
    ...
    def page(self, panel):
        self.index = 2
        self.write(panel, self.index, 2, "Deskchat Login", "yellow")
        self.index += 2
