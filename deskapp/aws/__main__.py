import argparse
import deskapp
from .mods import Startup
from .mods.ec2 import EC2


def main():
    parser = argparse.ArgumentParser(
                prog='Deskapp AWS',
                description='A Deskapp variant focused on AWS modules.',
                epilog='Another Ruckusist.com Project.')

    # Basic configuration
    parser.add_argument('--name', type=str, default="Deskapp AWS", help='Application name')
    parser.add_argument('--title', type=str, default="Deskapp AWS", help='Application title')
    parser.add_argument('--header', type=str, default="AWS Console", help='Header text')
